...
CREATE_USER_CONNECTION_COMMUNITY_SETTING = {
...
def backfill_create_user_connection_community_setting():
    communities_with_community_setting = list(ModelUtilities.get_model_filter(
        CommunitySettings, {'setting_type': CREATE_USER_CONNECTION_COMMUNITY_SETTING.get('setting_type')}).values_list(
    ...
    for community_instance in community_filter:
        CREATE_USER_CONNECTION_COMMUNITY_SETTING['community_instance'] = community_instance

        community_settings_instance = CommunitySettings.create_instance(CREATE_USER_CONNECTION_COMMUNITY_SETTING)
...
backfill_create_user_connection_community_setting()
