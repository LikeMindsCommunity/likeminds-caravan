...
CREATE_INTRO_COMMUNITY_SETTING = {
    'setting_type': 'create_intro_rooms',
    'setting_title': 'Create intro rooms',
    'setting_sub_title': '',
    'enabled': False,
    'enabled_by': None,
}
...
def backfill_create_intro_room_community_setting():
    communities_with_community_setting = list(ModelUtilities.get_model_filter(
        CommunitySettings, {'setting_type': CREATE_INTRO_COMMUNITY_SETTING.get('setting_type')}).values_list(
    ...
    for community_instance in community_filter:
        CREATE_INTRO_COMMUNITY_SETTING['community_instance'] = community_instance

        community_settings_instance = CommunitySettings.create_instance(CREATE_INTRO_COMMUNITY_SETTING)
...
backfill_create_intro_room_community_setting()
