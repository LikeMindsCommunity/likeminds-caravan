...
if __name__=="__main__":
    ...
    #
    insert_attributes("Legacy_cluster",1)
    insert_attributes("Profession_cluster",2)
    insert_attributes("Interests_cluster",3)
    insert_attributes("Geography_cluster",4)
