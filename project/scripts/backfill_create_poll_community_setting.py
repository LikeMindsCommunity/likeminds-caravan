...
CREATE_POLL_COMMUNITY_SETTING = {
    'setting_type': 'create_poll',
    'setting_title': 'Create Poll',
    'setting_sub_title': '',
    'enabled': True,
    'enabled_by': None,
}
...
def backfill_create_poll_community_setting():
    communities_with_community_setting = list(ModelUtilities.get_model_filter(
        CommunitySettings, {'setting_type': CREATE_POLL_COMMUNITY_SETTING.get('setting_type')}).values_list(
    ...
    for community_instance in community_filter:
        CREATE_POLL_COMMUNITY_SETTING['community_instance'] = community_instance

        community_settings_instance = CommunitySettings.create_instance(CREATE_POLL_COMMUNITY_SETTING)
...
backfill_create_poll_community_setting()
