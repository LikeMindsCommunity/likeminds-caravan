...
from .sdk_views import (SdkProjectView, InitiateSdkView, AuthenticateSdkView, OnboardingScreensView, 
                        SdkMauView, MigrateSendbirdView)
...
urlpatterns = [
    ...
    path('migrate/sendbird', MigrateSendbirdView.as_view(), name="migrate-sendbird"),
]
