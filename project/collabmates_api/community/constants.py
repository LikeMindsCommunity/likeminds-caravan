...
COMMUNITY_SETTING_TYPE_TITLE_MAPPING = {
    ...
    "enable_personalised_feed": "Enable personalised feed"
}
...
COMMUNITY_SETTING_TYPE_SUB_TITLE_MAPPING = {
    ...
    "enable_personalised_feed": "Enable personalised feed in community"
}
...
REPORT_TYPE_CONVERSATION = "conversation"
REPORT_TYPE_COMMUNITY = "community"
REPORT_TYPE_LINK = "link"
...
REPORT_TYPE_CHATROOM_INT = 1
REPORT_TYPE_CONVERSATION_INT = 2
REPORT_TYPE_COMMUNITY_INT = 3
REPORT_TYPE_LINK_INT = 4
...
REPORT_TYPES = {
    REPORT_TYPE_MEMBER: REPORT_TYPE_MEMBER_INT,
    REPORT_TYPE_CHATROOM: REPORT_TYPE_CHATROOM_INT,
    REPORT_TYPE_CONVERSATION: REPORT_TYPE_CONVERSATION_INT,
    REPORT_TYPE_COMMUNITY: REPORT_TYPE_COMMUNITY_INT,
...
REPORT_TYPES_INT = {
    REPORT_TYPE_MEMBER_INT: REPORT_TYPE_MEMBER,
    REPORT_TYPE_CHATROOM_INT: REPORT_TYPE_CHATROOM,
    REPORT_TYPE_CONVERSATION_INT: REPORT_TYPE_CONVERSATION,
    REPORT_TYPE_COMMUNITY_INT: REPORT_TYPE_COMMUNITY,
