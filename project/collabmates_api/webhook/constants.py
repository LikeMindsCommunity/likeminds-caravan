...
WEBHOOK_CHATROOM_JOIN_METHOD_ADDED_BY_CM = "added_by_cm"
WEBHOOK_CHATROOM_JOIN_METHOD_AUTO_FOLLOW_CHATROOM = "auto_follow_chatroom"
...
WEBHOOK_CHATROOM_LEAVE_METHOD_SELF = "self_leave"
