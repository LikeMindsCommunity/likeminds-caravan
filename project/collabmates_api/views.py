...
class SyncConversation(APIView):
    ...
    def is_attachments_uploaded(self, attachment_count, attachment_uploaded, member_id,
                                api_version, conversation_creator_id, conversation_device_id='', current_device_id=None):
...
class SyncMembers(APIView):
    ...
    def get_removed_members_data(self, member_id, chatroom_id, community_id, last_updated, page, paginate_by):
        ...
        if chatroom_id:
            ...
            return self.get_removed_members_of_member_joined_communities(member_id, last_updated)
    ...
    def get_removed_members_of_member_joined_communities(self, member_id, last_updated):
