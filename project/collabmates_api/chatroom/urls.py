...
from .view_chatroom_impl import (FetchChatroomView, CreateChatroomView, PinUnpinChatroomView, FetchAllChatroomView,
                                 ...
                                 ChatroomNotificationSettings, ChatroomParticipants, ChatroomInvites, ChatroomSettings, ChatroomUserSettings)
...
urlpatterns = [
    ...
    path('<str:chatroom_id>/settings/member/<str:participant_uuid>', ChatroomUserSettings.as_view(), name="chatroom_user_settings"),
]
