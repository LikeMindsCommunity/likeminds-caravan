...
class ChatroomImpl(ChatroomManager):
    ...
    def add_secret_chatroom_participant(self, req_body: dict, is_internal: bool = True, add_user_joined_message: bool = True, 
        ...
        if trigger_webhook:
            ChatroomImpl.trigger_chatroom_join_webhook.delay(community_id=chatroom_instance.community_id,
    ...
    @staticmethod
    @shared_task
    def trigger_chatroom_join_webhook(community_id: int, chatroom_id: int, users_list: list, join_method: str):
...
class ChatroomHelper:
    ...
    def make_secret_chatroom_relation_for_community_members(user_list, chatroom_id, community_id,
        ...
        if trigger_webhook:
            ChatroomImpl.trigger_chatroom_join_webhook.delay(community_id=community_id,
                                                             chatroom_id=chatroom_id,
