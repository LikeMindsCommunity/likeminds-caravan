...
from ..community.constants import (DIRECTORY_QUESTIONS_V2_ANSWER_KEY, DIRECTORY_QUESTIONS_V2_QUESTION_ID_KEY)
...
from ..raw_queries import (get_members_based_on_user_list_query,
                           ...
                           get_distinct_chatroom_creator_list,
...
from ..rest_api import (CommunitySerializerV1, get_error_context, MemberNotificationFlagSerializer)
...
from ..static_text import (SECRET_CHATROOM_VERSION_CODE_IOS, COMMUNITY_LEVEL_3_TEXT)
...
from .member_community_impl_helper import MemberCommunityHelper
...
class MemberCommunityImpl(MemberCommunityManager):
    ...
    @staticmethod
    def get_user_connections(community_instance, user_id):
        connections = ModelUtilities.get_model_filter(Connection, {
            'community': community_instance,
            'connection_by_id': user_id
        })
    ...
    def fetch_connections(self, user_uuid: str, page: int, page_size: int, status: str = "") -> dict:
        ...
        users_data = get_users_sdk_meta_dict(users_list)
