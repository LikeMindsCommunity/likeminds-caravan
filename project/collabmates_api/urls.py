...
from .community.community_view_impl import ApproveOrDeclineCommunity, CommunityJoinView, EditCommunityV1View
...
urlpatterns = [
    ...
    path('v1/edit_community', EditCommunityV1View.as_view(), name='edit_community_version_1'),
