...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            default=[],
            dest='community_id',
            help='Community id for filtering'
        )
    ...
    def _populate(self, models, options):
        ...
        community_ids = options['community_id']
        for doc in registry.get_documents(models):
            ...
            self.stdout.write("Indexing {} '{}' objects {}".format(
                queryset.count() if options['count'] else "all",
                doc.django.model.__name__,
                "(parallel)" if parallel else "")
            )

            kwargs = {}
            if DJANGO_VERSION >= (2,) and doc().django.queryset_pagination:
                kwargs = {'chunk_size': doc().django.queryset_pagination}
            qs = queryset.iterator(**kwargs)
