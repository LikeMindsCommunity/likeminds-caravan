...
SHARE_TEXT_ADMIN_PRIVATE_PAID_COMMUNITY = "I am building %s community on LikeMinds and I am inviting you to build this community together with me. Join now with this exclusive link. Auto-verification is enabled for 24 hours: %s"
SHARE_TEXT_MEMBER = 'I am part of %s community on LikeMinds.\n and I think you will find it interesting too.\n Know more about the community and apply to join using this link %s'
